    ...
    namespace WireCell::Cuda
    {
        ...
        class cuFftDFT : public IDFT
        {
            ...
            public:
                ...
                virtual void transpose(const scalar_t* in, scalar_t* out, int nrows, int ncols) const;
                virtual void transpose(const complex_t* in, complex_t* out, int nrows, int ncols) const;
        };
    }
