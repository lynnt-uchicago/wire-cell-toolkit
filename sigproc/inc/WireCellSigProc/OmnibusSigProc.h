...
namespace WireCell {
    namespace SigProc {
        ...
        class OmnibusSigProc : public Aux::Logger,
           ...
           public:
            OmnibusSigProc(
                ...
                bool use_roi_debug_mode = false, bool use_roi_refinement = true, 
                const std::string& decon_2D_init_tag = "decon_2D_init", const std::string& tight_lf_tag = "tight_lf",
	    ...
	    void rebase_waveform(WireCell::Array::array_xxf& arr, const int& nbins);
            ...
            std::string m_decon_2D_init_tag;
